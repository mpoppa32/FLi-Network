// Corsair — scheduled job: weekly DSCA FMS scrape
...
export const dscaFmsWeekly = onSchedule(
  {
    schedule: "0 9 * * 6",
    timeZone: "UTC",
    region: "us-central1",
  ...
  async (event) => {
    const jobId = generateJobId("dscaFmsWeekly");
    const log = createLogger({ source: "dsca_fms", jobId });

...
**State anchor:** commit `50257ad` (P13.396) — the newest `P13.x` marker on `main`. Later commits (docs, tests, CI machinery) introduce no new runtime marker, so this anchor holds until the next marked change.
